...
public class StorageMap {
	...
	/**
	 * To register the value for a variable, we specify the variable name and the
	 * expected current value for the variable. If there is already a registered
	 * value for the variable with this name, the old value will be replaced by the
	 * new one.
	 * 
	 * @param name              the name of the variable for which we wish to
	 *                          register the (new) value
	 * @param ingredientStorage the value for the variable
	 */
	...
	public Map<String, Storage> getIngredientsStorage() {
