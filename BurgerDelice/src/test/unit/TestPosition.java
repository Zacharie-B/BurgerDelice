...
public class TestPosition {
	...
	public void preparePosition() {
		...
		this.customer1Top = new Customer(new Block(2, 0),1, 1, false, true, 2);
		this.customer2 = new Customer(new Block(2, 1),2, 2, false, true, 2);
		this.customer3Down = new Customer(new Block(2, 2),3, 2, false, true, 2);
		this.customer4Right = new Customer(new Block(3, 1),4, 2, false, true, 2);
		this.customer5Left = new Customer(new Block(1, 1),5, 2, false, true, 2);
